...
CREATE TABLE IF NOT EXISTS buildings (
    ...
    category ENUM('木结构','砖石','园林','法式') NOT NULL COMMENT '所属分类',
...
CREATE TABLE IF NOT EXISTS building_details (
    ...
    section_type ENUM('history','structure','material','culture') NOT NULL COMMENT '章节类型',
...
CREATE TABLE IF NOT EXISTS images (
    ...
    image_type ENUM('全景','结构','斗拱','彩绘','其他') DEFAULT '其他' COMMENT '图片类型',
